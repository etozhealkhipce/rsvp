...
const features = [
  {
    ...
    description:
      "Words are centered at the focal point, keeping your eyes perfectly still while reading.",
  ...
  },
  {
    ...
    description:
      "Train your brain to process words visually, bypassing the habit of mentally pronouncing each word.",
  ...
  },
  {
    ...
    description:
      "Start slow and accelerate gradually, letting your mind adapt naturally to faster reading speeds.",
          ...
          <div className="container mx-auto max-w-7xl px-6 relative z-10">
            ...
            >
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Master the art of speed reading with RSVP. Our technology
                displays words one at a time at your optimal focal point,
                eliminating eye movement and dramatically increasing reading
                speed.
              </motion.p>
            ...
            <motion.div
              className="my-20 flex flex-col md:grid grid-cols-3 gap-6 max-w-2xl mx-auto"
          ...
          <div className="container mx-auto max-w-7xl px-6 relative">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Our scientifically-backed approach helps you read faster while
                maintaining full comprehension of the material.
              </p>
            </motion.div>
                ...
                <CardContent className="relative p-16 text-center">
                  ...
                  >
                    ...
                    <p className="text-xl text-muted-foreground mb-10 max-w-xl mx-auto">
                      Join thousands of readers who have dramatically improved
                      their reading speed. Start your journey today.
                    </p>
                    <Button
                      size="lg"
                      onClick={() => navigate("/register")}
