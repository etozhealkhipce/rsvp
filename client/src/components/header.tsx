      ...
      <div className="container flex h-20 items-center justify-between gap-4 px-6 mx-auto max-w-7xl">
        <div className="flex items-center gap-8">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-bold text-xl hidden sm:inline-block group-hover:gradient-text transition-all" data-testid="text-logo">
              RSVP Reader
            </span>
          </Link>
          ...
          {user && (
            <nav className="flex items-center gap-2">
              <Button
                ...
                size="sm"
                className={location === "/" ? "gradient-primary border-0 text-white rounded-full px-5" : "rounded-full px-5"}
                asChild
        ...
        <div className="flex items-center gap-3">
          ...
          {user ? (
            ...
            <Button asChild className="rounded-full px-6" data-testid="button-login">
